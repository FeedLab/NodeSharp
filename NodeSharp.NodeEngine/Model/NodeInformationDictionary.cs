...
public class NodeInformationDictionary : Dictionary<string, NodeInformation>
{
    public NodeInformationDictionary()
    {
        ...
        Add("Inject", new NodeInformation("Inject", true, true, informationText,"\ue713"));
        Add("Debug", new NodeInformation("Debug", false, true, informationText,"\ue714"));
        Add("Delay", new NodeInformation("Delay", false, true, informationText,"\ue715"));
        Add("RandomNumber", new NodeInformation("RandomNumber", false, true, informationText,"\ue716"));
    }
}