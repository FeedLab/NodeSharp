...
public partial class LabeledBorder : Grid
{
    ...
    public static readonly BindableProperty InnerContentProperty =
        BindableProperty.Create(nameof(InnerContent), typeof(View), typeof(LabeledBorder), null,
    ...
    {
        if (bindable is LabeledBorder control && newValue is View contentView && control.ContentGrid != null)
        {
